...
def test_missing_robots_allows_everything() -> None:
    policy = RobotsPolicy(_client_returning(lambda r: httpx.Response(404)), "aquaticy/0.1")
...
def test_oversized_pdf_is_skipped() -> None:
    from aquaticy import fetch as fetch_mod
